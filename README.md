...
- `image_name` - Substring to look for in the engine's image list output (default: `sequoia`). Use this when validating against a custom image.
...
ansible-playbook validate.yml -i dev/inventory --tags images -e "image_name=ghcr.io/myorg/my-image"
```
